...
if __name__ == '__main__':
    ...
    config = ActivityConfig(start_trial=start_trial, num_trials=1, num_episodes=1000, out_path='result/cartpole/ddqn-01-with-wrapper/')
    agent_builder = DDQNAgentBuilder(num_actions)
    milestone_episodes = []
