...
class DQNAgentBuilder(AgentBuilder):
    def create_agent(self, seed, initial_policy_path=None):
        ...
        c = 100
        return DQNWithTargetNetworkAgent(memory_size, batch_size, dqn_dims, self.normaliser, c, seed)
...
if __name__ == '__main__':
    ...
    config = ActivityConfig(start_trial=start_trial, num_trials=10, num_episodes=10000, out_path='result/lunarlander/dqnwtn-03/')
