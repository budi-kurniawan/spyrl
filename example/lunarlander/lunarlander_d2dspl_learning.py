...
if __name__ == '__main__':
    ...
    max_num_samples_for_classifier = 500 #4000 #3000 #200 #300 #500 #1000 #1500 #2000
    config = ActivityConfig(num_trials = 10, num_episodes=5_000, out_path='result/lunarlander/d2dspl-04/')
