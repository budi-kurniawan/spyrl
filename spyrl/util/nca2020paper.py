...
if __name__ == '__main__':
    ...
    parent_path = '/home/budi2020/Documents/PHD/my-papers/neuralComputingAndApplications/results'
...
#         draw(data_path, plot_path)
    ...
    for i in range(1, 5):
        ...
        plot_path = parent_path + '/d2dspl-d2dsql-aircombat-test' + str(i) + 'new.png'
