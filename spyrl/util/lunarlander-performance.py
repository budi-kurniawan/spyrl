...
if __name__ == '__main__':
    ...
    data_sources = [
            ...
            DataSource(label='acet-21-1K', data_parent_path=parent + 'acet-21/performance-1000', num_trials=3),
            DataSource(label='acet-21-2K', data_parent_path=parent + 'acet-21/performance-2000', num_trials=3),
            DataSource(label='acet-21-4K', data_parent_path=parent + 'acet-21/performance-4000', num_trials=3),
